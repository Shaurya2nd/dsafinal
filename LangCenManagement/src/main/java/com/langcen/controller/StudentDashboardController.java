...
public class StudentDashboardController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // ✅ NEW: Fetch all students and set in request
            List<StudentModel> allStudents = dashboardService.getAllStudents();
    ...
    private void showAllStudents(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Unable to display student list.");
        }
    }
}
